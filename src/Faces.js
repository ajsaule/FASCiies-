...
export default class Faces extends Component {
    ...
    renderFaces = e => {
        // make some logic in here to check what is inside the input box.
        // if "" empty string 
        console.log(this.state.faces) // prints all faces ? 
        ...
        return (
            <div >
                <nav>
                    ...
                    {/* put icon here */}<input className="search-bar" type="text" id="search" />
